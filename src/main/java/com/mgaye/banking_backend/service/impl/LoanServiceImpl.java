...
// // LoanApplicationResponse submitApplication(String userId,
...
// @Override
// @Transactional
// public LoanApplicationResponse submitApplication(String userId,
// LoanApplicationRequest request) {
...
// throw new LoanRejectedException("Insufficient credit score for requested
// amount");
// }
...
// // Notify user
// notificationService.sendLoanApplicationConfirmation(userId,
// savedLoan.getId());
...
// public LoanScheduleResponse generatePaymentSchedule(UUID loanId, String
// userId) {
...
// notificationService.sendLoanApprovalNotification(loan.getUser().getId(),
// loanId);
// }
