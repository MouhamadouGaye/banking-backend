...
// @Override
// public Transaction buildTransaction(TransactionRequest request, BankAccount
// account) {
...
// {
// return transactionRepo.findByIdAndUserId(UUID.fromString(transactionId),
// userId)
// .orElseThrow(() -> new TransactionNotFoundException(transactionId));
// }

// @Override
// public List<Transaction> getAccountTransactions(UUID accountId, LocalDate
...
// return transactionRepo.findByAccountIdAndTimestampBetween(accountId, start,
// end);
// }
