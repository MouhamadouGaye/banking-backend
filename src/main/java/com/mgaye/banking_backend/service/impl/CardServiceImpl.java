...
// private final com.mgaye.banking_backend.service.CardSecurityService
// cardSecurityService;
...
// BankAccount account =
// accountRepository.findByIdAndUserId(request.accountId(), request.userId());
// if (account == null) {
...
// throw new IllegalArgumentException("Account currency doesn't match requested
// card currency");
// }
...
// .status(request.virtualCard() ? Card.CardStatus.ACTIVE :
