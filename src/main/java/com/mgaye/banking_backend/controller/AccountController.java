...
// public ResponseEntity<List<AccountResponse>> getUserAccounts(@CurrentUser
// User user) {
// List<AccountResponse> accounts =
// accountService.getUserAccounts(user.getId()).stream()
...
// BankAccount createdAccount = accountService.createAccount(user.getId(),
// request);
